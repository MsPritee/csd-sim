/**
 * DecimalLearnLayout - Main layout for decimal learn module
 * Combines header, navigation, and lesson content
 */

import { LessonHeader } from './components/LessonHeader'
import { Lesson1_WhatIsDecimal } from './lessons/Lesson1_WhatIsDecimal'
import { Lesson2_WhyBase10 } from './lessons/Lesson2_WhyBase10'
...
import { Lesson5_PlaceValue } from './lessons/Lesson5_PlaceValue'
import { LessonFinal_GotIt } from './lessons/LessonFinal_GotIt'
import { useDecimalLearnStore } from '../../../stores/decimalLearnStore'
import type { LessonNumber } from './types/lesson.types'

interface DecimalLearnLayoutProps {
  onBackToHome: () => void
}

const TOTAL_LESSONS = 5

export function DecimalLearnLayout({ onBackToHome }: DecimalLearnLayoutProps) {
  const { 
    currentLesson, 
    completedLessons, 
    setCurrentLesson, 
    markLessonComplete 
  } = useDecimalLearnStore()
  ...
  const renderLesson = () => {
    switch (currentLesson) {
      case 1:
        return <Lesson1_WhatIsDecimal onComplete={() => markLessonComplete(1)} />
      case 2:
        return <Lesson2_WhyBase10 onComplete={() => markLessonComplete(2)} />
      case 3:
      ...
      case 5:
        return <Lesson5_PlaceValue onComplete={() => markLessonComplete(5)} />
      case 6:
