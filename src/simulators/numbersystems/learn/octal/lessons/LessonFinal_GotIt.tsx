      ...
      <div className="text-center space-y-6">
        ...
        <div className="space-y-4">
          <p className="text-xl" style={{ color: 'var(--text-primary)' }}>
            You've completed the Octal Number System learning module!
          </p>
          ...
          <div className="p-6 rounded-xl" style={{ backgroundColor: 'var(--accent-bg)' }}>
            ...
            <div className="text-left space-y-2" style={{ color: 'var(--text-secondary)' }}>
              <p>✅ Lesson 1: What is a number system and why octal matters</p>
              <p>✅ Lesson 2: What base means and why octal is base 8</p>
              <p>✅ Lesson 3: How position affects digit values</p>
              <p>✅ Lesson 4: How to calculate position value using powers of 8</p>
          ...
          <div className="p-6 rounded-xl" style={{ backgroundColor: 'var(--bg-tertiary)' }}>
            ...
            <div className="text-left space-y-2" style={{ color: 'var(--text-secondary)' }}>
              <p>• Octal uses 8 digits: 0, 1, 2, 3, 4, 5, 6, 7</p>
              <p>• Each position represents a power of 8 (1, 8, 64, 512...)</p>
              <p>• Position determines the value of each digit</p>
              <p>• Octal is useful in computing for compact binary representation</p>
            </div>
          </div>
