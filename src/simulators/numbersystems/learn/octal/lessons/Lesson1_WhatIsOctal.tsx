/**
 * Lesson 1: Introduction to Octal Number System
...
export function Lesson1_WhatIsOctal({ onComplete }: Lesson1Props) {
  ...
  const everydayOctal = ['7', '15', '42', '177']
  
  const questions = [
    {
      id: 1,
      question: "Why do we use 8 digits?",
    ...
    <div className="space-y-8">
      ...
      <div className="text-center space-y-6">
        <h2 className="text-3xl font-bold" style={{ color: 'var(--text-primary)' }}>
          Meet the Octal Number System
        </h2>

        {/* Everyday octal numbers */}
        <div className="space-y-4">
          <p className="text-lg" style={{ color: 'var(--text-secondary)' }}>
            Octal numbers are used in computing:
          </p>
          <div className="flex justify-center gap-6 flex-wrap">
            {everydayOctal.map((num) => (
              <div
                key={num}
        ...
        {state.revealedQuestions.length === 0 && (
          <div className="space-y-4 animate-fade-in">
            <p className="text-xl font-medium" style={{ color: 'var(--text-primary)' }}>
              But have you ever wondered how octal numbers actually work?
            </p>
            <Button
              variant="primary"
            ...
            {state.allQuestionsRevealed && (
              <div className="animate-fade-in-up p-6 rounded-xl" style={{ backgroundColor: 'var(--accent-bg)' }}>
                <p className="text-lg font-bold" style={{ color: 'var(--accent-primary)' }}>
                  🎯 Great! You've discovered the key questions about octal numbers.
                </p>
      ...
      <div className="mt-8 p-6 rounded-xl" style={{ backgroundColor: 'var(--bg-tertiary)' }}>
        ...
        <p className="text-base" style={{ color: 'var(--text-secondary)' }}>
          ...
          Octal is the number system that uses 8 digits (0-7)!
        </p>
      </div>
    </div>
  )
