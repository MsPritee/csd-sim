/**
 * BinaryLearnLayout - Main layout for binary learn module
 * Combines header, navigation, and lesson content
 */

import { LessonHeader } from '../components/LessonHeader'
import { Lesson1_WhatIsBinary } from './lessons/Lesson1_WhatIsBinary'
import { Lesson2_WhyBase2 } from './lessons/Lesson2_WhyBase2'
...
import { useBinaryLearnStore } from '../../../../stores/binaryLearnStore'
import type { LessonNumber } from './types/lesson.types'

interface BinaryLearnLayoutProps {
  onBackToHome: () => void
}

const TOTAL_LESSONS = 5

export function BinaryLearnLayout({ onBackToHome }: BinaryLearnLayoutProps) {
  const { 
    currentLesson, 
    completedLessons, 
    setCurrentLesson, 
  ...
  const renderLesson = () => {
    switch (currentLesson) {
      case 1:
        return <Lesson1_WhatIsBinary onComplete={() => markLessonComplete(1)} />
      case 2:
        return <Lesson2_WhyBase2 onComplete={() => markLessonComplete(2)} />
      case 3:
