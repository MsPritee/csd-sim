/**
 * Lesson 1: Introduction to Binary Number System
...
export function Lesson1_WhatIsBinary({ onComplete }: Lesson1Props) {
  ...
  const everydayBinary = ['101', '1101', '10010', '11111111']
  
  const questions = [
    {
      id: 1,
      question: "Why do we use only 2 digits?",
      visual: "0 1",
      answerIn: "Lesson 2"
    },
    {
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="text-center space-y-6">
        ...
        {/* Everyday binary numbers */}
        <div className="space-y-4">
          <p className="text-lg" style={{ color: 'var(--text-secondary)' }}>
            Computers use binary numbers everywhere:
          </p>
          <div className="flex justify-center gap-6 flex-wrap">
            {everydayBinary.map((num) => (
              <div
                key={num}
        ...
        {state.revealedQuestions.length === 0 && (
          <div className="space-y-4 animate-fade-in">
            <p className="text-xl font-medium" style={{ color: 'var(--text-primary)' }}>
              But have you ever wondered how binary numbers actually work?
            </p>
            <Button
              variant="primary"
            ...
            {state.allQuestionsRevealed && (
              <div className="animate-fade-in-up p-6 rounded-xl" style={{ backgroundColor: 'var(--accent-bg)' }}>
                <p className="text-lg font-bold" style={{ color: 'var(--accent-primary)' }}>
                  🎯 Great! You've discovered the key questions about binary numbers.
                </p>
      ...
      <div className="mt-8 p-6 rounded-xl" style={{ backgroundColor: 'var(--bg-tertiary)' }}>
        ...
        <p className="text-base" style={{ color: 'var(--text-secondary)' }}>
          ...
          Binary is the number system that computers use, with only 2 digits!
        </p>
      </div>
    </div>
  )
