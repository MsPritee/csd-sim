 ...
 * Game-like challenges to test understanding of L1-L4 concepts
 */
...
export function Lesson5_PlaceValue({ onComplete }: Lesson5Props) {
  ...
  const challenges = [
    {
      ...
      question: 'Which number is represented?',
      display: '4 × 100\n7 × 10\n2 × 1',
      options: ['472', '742', '427'],
      correct: '472'
    },
    {
      id: 2,
      type: 'multiple-choice',
      question: 'What is the place value of 7?',
      display: '572',
      options: ['7', '70', '700'],
      correct: '70'
    },
    ...
    },
    {
      ...
      target: 428,
      positionNames: ['Hundreds', 'Tens', 'Ones']
    }
  ]
  ...
  const handleBuilderDigitChange = (position: number, value: number) => {
    ...
    if (currentChallengeData.type === 'builder') {
      const builtNumber = parseInt(newDigits.join(''))
    ...
    <div className="space-y-8">
      ...
      <div className="text-center space-y-6">
        ...
        <p className="text-base" style={{ color: 'var(--text-secondary)' }}>
          Test everything you learned in Lessons 1-4!
        </p>
        ...
        {!isComplete && currentChallengeData && (
          <div className="space-y-6">
            ...
            {/* Builder challenge */}
            {currentChallengeData.type === 'builder' && (
              <div className="space-y-4">
                ...
                <div className="p-4 rounded-lg" style={{ backgroundColor: 'var(--bg-tertiary)' }}>
                  <p className="text-sm" style={{ color: 'var(--text-secondary)' }}>Target: {currentChallengeData.target}</p>
                  <p className="text-2xl font-bold mt-1" style={{ color: 'var(--accent-primary)' }}>
                    Built: {parseInt(state.builderDigits.join(''))}
                  </p>
                </div>
            ...
            <div className="p-8 rounded-xl" style={{ backgroundColor: 'var(--accent-bg)' }}>
              ...
              {state.correctAnswers === challenges.length && (
                <p className="text-lg mt-2" style={{ color: 'var(--text-secondary)' }}>
                  Perfect score! You've mastered decimal number systems!
                </p>
              )}
            </div>
