/**
 * Binary Learn Store - Zustand store for progress tracking
 */

import { create } from 'zustand'
import type { LessonNumber, LessonProgress } from '../simulators/numbersystems/learn/binary/types/lesson.types'

interface BinaryLearnStore extends LessonProgress {
  // User preferences
...
export const useBinaryLearnStore = create<BinaryLearnStore>((set) => ({
  // Initial state
  currentLesson: 1,
