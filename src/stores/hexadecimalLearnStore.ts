/**
 * Hexadecimal Learn Store - Zustand store for progress tracking
 */

import { create } from 'zustand'
import type { LessonNumber, LessonProgress } from '../simulators/numbersystems/learn/hexadecimal/types/lesson.types'

interface HexadecimalLearnStore extends LessonProgress {
  // User preferences
...
export const useHexadecimalLearnStore = create<HexadecimalLearnStore>((set) => ({
  // Initial state
  currentLesson: 1,
